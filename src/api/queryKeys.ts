...
export const queryKeys = {
  ...
  user: {
    ...
    /** 내가 작성한 리뷰 목록의 prefix 키 (invalidate용) */
    myReviewsAll: () => [...queryKeys.user.all, "reviews"] as const,

    /** 내가 작성한 리뷰 목록 (정렬 기준 포함) */
    myReviews: (sortBy: string) => [...queryKeys.user.all, "reviews", sortBy] as const,
  },
