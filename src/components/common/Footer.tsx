...
const navItems: NavItem[] = [
  {
    ...
    label: "홈",
    path: "/home",
    activeIcon: "/images/icons/footer/home_fill.svg",
    inactiveIcon: "/images/icons/footer/home_blank.svg",
  },
  {
    id: "report",
    label: "제보하기",
    path: "/report",
    activeIcon: "/images/icons/footer/report_fill.svg",
  ...
  },
  {
    ...
    label: "마이페이지",
    path: "/mypage",
    activeIcon: "/images/icons/footer/mypage_fill.svg",
    inactiveIcon: "/images/icons/footer/mypage_blank.svg",
  },
];
...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 top-auto mx-auto w-full max-w-[480px] bg-white shadow-[0px_-3px_8px_rgba(163,163,163,0.15)] z-[20] pb-[calc(env(safe-area-inset-bottom,0px)+12px)]">
