...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 top-auto mx-auto w-full max-w-[480px] bg-white shadow-[0px_-3px_8px_rgba(163,163,163,0.15)] z-[20] pb-[calc(env(safe-area-inset-bottom,0px)+24px)]">
